...
#else
	this->m_brush[0] = CreateSolidBrush(RGB(252, 202, 3)); //-- cuando esta activo
	this->m_brush[1] = CreateSolidBrush(RGB(0, 0, 0)); //-- cuando esta desactivado
	this->m_brush[2] = CreateSolidBrush(RGB(255, 0, 0)); //-- Encabezado
...
void CServerDisplayer::PaintName() // OK
{
	...
	//TextOut(hdc,120,0,CONNECTSERVER_CLIENT,sizeof(CONNECTSERVER_CLIENT));
